    ...
    <div className="relative min-h-screen overflow-hidden bg-black font-sans">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-8 sm:space-y-12">
          ...
          {/* Subtitle */}
          <h2 className="text-xl sm:text-2xl lg:text-3xl text-gray-300 font-light max-w-4xl mx-auto leading-relaxed drop-shadow-lg font-mono">
          ...
          <div className="pt-8 sm:pt-12">
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 items-center justify-center">
              ...
              >
                ...
                <div className="relative bg-gray-900/80 backdrop-blur-sm rounded-2xl p-2 border border-gray-700/50 group-hover:border-blue-500/50 transition-all duration-300">
                  <Image
                    ...
                    width={250}
                    height={167}
                    className="rounded-xl object-cover w-full h-auto max-w-[250px]"
                    priority
                  />
              ...
              {/* Daivid Option - Disabled */}
              <div className="group relative inline-block opacity-50 cursor-not-allowed rounded-2xl">
                <div className="absolute inset-0 bg-gradient-to-r from-gray-500/20 to-gray-600/20 rounded-2xl blur-xl"></div>
                <div className="relative bg-gray-900/80 backdrop-blur-sm rounded-2xl p-2 border border-gray-700/50">
                  <Image
                    src="/Daivid.png"
                    alt="Daivid - Coming Soon"
                    width={250}
                    height={167}
                    className="rounded-xl object-cover w-full h-auto max-w-[250px] grayscale"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent rounded-xl flex items-end justify-center pb-4">
                    <span className="text-gray-400 font-semibold text-lg drop-shadow-lg">
                      Coming Soon
                    </span>
                  </div>
                </div>
              ...
              {/* Katyusha Option - Disabled */}
              <div className="group relative inline-block opacity-50 cursor-not-allowed rounded-2xl">
                <div className="absolute inset-0 bg-gradient-to-r from-gray-500/20 to-gray-600/20 rounded-2xl blur-xl"></div>
                <div className="relative bg-gray-900/80 backdrop-blur-sm rounded-2xl p-2 border border-gray-700/50">
                  <Image
                    src="/Katyusha.png"
                    alt="Katyusha - Coming Soon"
                    width={250}
                    height={167}
                    className="rounded-xl object-cover w-full h-auto max-w-[250px] grayscale"
                  />
